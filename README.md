...
For security reasons, the API key has been added to `.gitignore`. Therefore, to use the application, you need to create an `appsettings.json` file in the directory
```
“..\CryptoApp\CryptoApp\bin\Debug\net8.0-windows”.
```
# What should the appsettings.json file look like?

You need to add the following code to the file:
```
{
  “CoinCapApi”: {
    “ApiKey”: “Your API key from https://pro.coincap.io/dashboard”
  }
}
```
...
The following main tasks have been completed:

1. This is a multi-page application written in C# using WPF technology;
2. The home page displays the top 10 most popular currencies;
3. A page has been added that allows users to view additional information about a currency;
4. The ability to search for a currency by name or code;
5. Use of MVVM.

The following additional tasks have been completed:

1. Displaying a currency quote chart on the currency details page.
